                        ...
                        <div class="card p-4">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <small class="text-secondary"><span class="opacity-75 me-2">Data de criação:</span><strong>{{ date('Y-m-d H:i:s', strtotime( $note ['created_at']))}}</strong></small>
                                    @if($note['created_at'] != $note ['updated_at'])
                                        <samll class='text-secondary'><span class="opacity-75 me-2">Última atualização:</span><strong>{{ date('Y-m-d H:i:s', strtotime( $note ['updated_at']))}}</strong></samll>
                                    @endif                          
                                </div>
